            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-title">
                        <span class="title">MANTENIMIENTO DE EQUIPOS</span>

                    </div>
                    <?php if (\Entrust::can('security_equipments_search') || \Entrust::hasRole('superuser')) : ?>
...
<div class="clearfix"></div>
                    ...
                    <a href="<?php echo e(route('exporting.equipments_csv')); ?>" class="btn btn-default pull-right button-rigth export_  <?php echo e(icon_permission('security_equipments_export')); ?>" >CSV</a>
                    <a href="<?php echo e(route('exporting.equipments')); ?>" class="btn btn-default pull-right button-rigth export_  <?php echo e(icon_permission('security_equipments_export')); ?>">XLSX</a>
                    <label for="export_" style="padding-top: 22px;" class="pull-right <?php echo e(icon_permission('security_equipments_export')); ?>">Exportar : </label>
                    <button type="submit" class="btn btn-default pull-right button-rigth <?php echo e(icon_permission('security_equipments_search')); ?>" id="button-s">BUSCAR</button>

                    <?php if (\Entrust::can('security_equipments_store') || \Entrust::hasRole('superuser')) : ?>
			...
			<?php if (\Entrust::can('security_equipments_show') || \Entrust::hasRole('superuser')) : ?>
				<div class="card-body">
...
<!-- DELETE FORM -->
<?php echo Form::open([ 'route' => ['security.equipments.destroy', ':ROW_ID'], 'method' => 'DELETE', 'id' => 'form-equipo-delete']); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script id="command-template" type="text/x-kendo-template">
        ...
        <a title="Editar"   href="\#" class="edit-equipo-entity kendo-buttons <?php echo e(icon_permission('security_equipments_update')); ?>">
            <i class="fa fa-lg fa-pencil"></i>
        </a>
        <a title="Eliminar" href="\#" class="delete-equipo-entity <?php echo e(icon_permission('security_equipments_destroy')); ?>">
    ...
    <script src="<?php echo e(asset('js/modules/security/equipments/functions_equipments.js')); ?>"></script>
    <script type="text/javascript">
      var permission_search_user ="<?php echo e(icon_permission('security_equipments_search')); ?>"
		...
		//~ console.log('sadasd');
        var url_load_equipments       = "<?php echo e(route('security.equipments.show')); ?>";
        var ConfigSettings = newModalSettings_equipments();

        var ConfigCRUD     = newModalCRUD_equipments();

        ConfigSettings.entity     = 'EQUIPOS';
        ConfigSettings.selector   = 'equipo';
        ConfigSettings.edit.url   = "<?php echo e(route('security.equipments.edit', ':ROW_ID')); ?>";
        ConfigSettings.create.url = "<?php echo e(route('security.equipments.create')); ?>";
        ConfigSettings.delete.url = "<?php echo e(route('security.equipments.delete', ':ROW_ID')); ?>";
        //console.log(ConfigSettings)
        ConfigCRUD.init(ConfigSettings);

    </script>

    <script src="<?php echo e(asset('js/modules/security/equipments/index.js')); ?>"></script>
