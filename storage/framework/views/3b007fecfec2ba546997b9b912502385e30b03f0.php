...
<li>Reporte Mensual de Disponibilidad del Servicio</li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <span class="title">Reporte Mensual de Disponibilidad del Servicio</span>
                    </div>
                ...
                <div class="card-body">
                    <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
                        ...
                        <form class="form-inline" id="form-search">
                            ...
                            <?php if (\Entrust::can('module_report_service_availability_search') || \Entrust::hasRole('superuser')) : ?>
                            ...
                            <a href="<?php echo e(route('module.report.service.availability.export.csv')); ?>" disabled="disabled"
                                class="btn btn-default pull-right button-rigth export_  <?php echo e(icon_permission('module_report_service_availability_export')); ?>" >CSV</a>
                            <a href="<?php echo e(route('module.report.service.availability.export')); ?>" disabled="disabled"
                                class="btn btn-default pull-right button-rigth export_  <?php echo e(icon_permission('module_report_service_availability_export')); ?>" id="export_xlsx">XLSX</a>
                            <label for="export_" style="padding-top: 22px;"
                                class="pull-right <?php echo e(icon_permission('module_report_service_availability_export')); ?>">Exportar : </label>
                            <a href="#"
                                class="btn btn-default pull-right button-rigth <?php echo e(icon_permission('module_report_service_availability_search')); ?>"
...
<script type="text/javascript">
    var permission_search_app_most_used ="<?php echo e(icon_permission('module_report_service_availability_search')); ?>"
        ...
        var url_load_data = "<?php echo e(route('module.report.service.availability.load')); ?>";

      

</script>
<script src="<?php echo e(asset('js/modules/ubigeo/index.js')); ?>"></script>
<script src="<?php echo e(asset('js/modules/report/ServiceAvailability/index.js')); ?>"></script>
<script>
