<div class="row" style="">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <?php echo e(Form::select('cmb_localidad',$localidad=[], null, ['id' => 'cmb_localidad', 'class' => 'form-control select2 selectUbi', 'data-placeholder' => 'Seleccione Localidad'])); ?>
