...
<li>TRAFICO DE CONTENIDO WEB BLOQUEADO</li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <span class="title">TRAFICO DE CONTENIDO WEB BLOQUEADO</span>
                    </div>
                ...
                <div class="card-body">
                    <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
                        ...
                        <form class="form-inline" id="form-search">
                            ...
                            <a href="<?php echo e(route('exporting.trafico_blc')); ?>"
...
<script type="text/javascript">
    ...
    $('#fecha_fin').datetimepicker({
        ...
        var url_load_data = "<?php echo e(route('module.trafico.blocked.load')); ?>";

      

</script>
<script src="<?php echo e(asset('js/modules/ubigeo/index.js')); ?>"></script>
<script src="<?php echo e(asset('js/modules/trafico/blocked/index.js')); ?>"></script>
<script>
