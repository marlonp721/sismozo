...
<li>Reporte de Sessiones de Cliente</li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <span class="title">Sesiones de Clientes - Datos Históricos</span>
                    </div>
                ...
                <div class="card-body">
                    <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
                        <form class="form-inline" id="form-search">
                            ...
                            <?php if (\Entrust::can('module_wifi_wirelessclienthistorical_search') || \Entrust::hasRole('superuser')) : ?>
                            ...
                            <a href="<?php echo e(route('module.wifi.sessiondata.export.csv')); ?>"
                            ...
                            <a href="<?php echo e(route('module.wifi.sessiondata.export')); ?>"
                            ...
                            <label for="export_" style="padding-top: 22px;"
                                ...
                                <a href="#"
                                class="btn btn-default pull-right button-rigth <?php echo e(icon_permission('module_wifi_wirelessclienthistorical_search')); ?>"
...
<script>
    ...
    var url_load_wireless = "<?php echo e(route('module.wifi.loadwirelesshistorical')); ?>";
</script>
<script type="text/javascript">
    ...
    var col = [
        ...
        {field:'ap_name',sortable:true,   title:'APP_NAME', attributes:{'class':'text-center'}, width: 90},
        ...
        {field:'accion_filewifi',sortable:true,   title:'ACCIÓN', template:kendo.template( "<a href='/SSRA_FileTransferDataEntries/DataEntry_Wifi_Sessions/procesados/#: historico #' download='#: historico #'>Descargar</a>"), attributes:{'class':'text-center','data-id' : "#: id #"}, width: 100},
    ];
    (new KendoSettings())
